package xyz.pixelsky.wirelessredstone.Config;

import xyz.pixelsky.wirelessredstone.WirelessRedstone;

import java.util.ArrayList;

import static xyz.pixelsky.wirelessredstone.Config.C_Utility.addData;
...
public class C_Set {
    ...
    public static ArrayList<String> getDefaultConfig(){
        ...
        addDescription("Supported languages: EN (English), DE (German), NL (Dutch), CZ (Czech).");
    ...
    private static void addKeyAndValue(String key, Object value){
        fileLines.add(C_Utility.addData(key, value).getInline());
    }

    private static void addKeyAndValue(String key, Object value, String comment){
        fileLines.add(C_Utility.addData(key, value, comment).getInline());
    }

    private static void addDescription(String description){
        fileLines.add(C_Utility.addData(description).getInline());
    }

    private static void addNewLine(){
        fileLines.add(C_Utility.addData("").getInline());
    }
}
